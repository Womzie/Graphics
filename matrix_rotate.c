...
int read_object(FILE *f, int onum)
{
  ...
  M2d_mat_mult_points(x[onum],y[onum],t, x[onum], y[onum], numpoints[onum]);
...
int main(int argc, char **argv)
{
  ...
  double px[MAXOBJS][MAXPOLYS][MAXPTS];
  double py[MAXOBJS][MAXPOLYS][MAXPTS];
