...
double red[10]   = {1, 1, 0.9, 0.9, 0.4, 0, 0, 0, 0, 0.5};
double green[10] = {0.9, 0.5, 0.1, 0, 0.1, 0.1, 0.5, 0.5, 0.5, 0.8};
double blue[10]  = {0, 0, 0.1, 0.5, 0.4, 0.5, 0.9, 0.5, 0.3, 0.1};
